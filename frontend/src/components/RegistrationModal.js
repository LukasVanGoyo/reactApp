...
const RegistrationModal = ({show, handleCloseModal}) => {
    ...
    return(
        <Modal className="registration-page-wrapper" show={show} onHide={handleCloseModal}>
            <Modal.Header closeButton >
                <Modal.Title>Załóż konto</Modal.Title>
            </Modal.Header>
            <Modal.Body>
